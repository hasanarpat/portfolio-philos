...
export function ThinkingsArchive() {
  ...
  const filteredThinkings = selectedTag ? thinkings.filter((t) => t.tags.includes(selectedTag)) : thinkings
    ...
    <div className="min-h-screen pt-24 pb-20">
      ...
      <div className="max-w-5xl mx-auto px-6 mb-16">
        <div className="border border-primary/30 bg-card/20 p-8 font-mono text-sm">
          ...
          <div className="text-foreground/70 leading-relaxed">
            <p>Unfiltered fragments. Short-form notes on building, debugging, and thinking.</p>
            <p className="mt-2">These aren't essays. They're mental breadcrumbs left during the work.</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="mb-12 border border-primary/20 bg-card/10 p-6">
          <div className="font-mono text-xs text-primary mb-4 uppercase tracking-widest">[Filter.Tags]</div>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4 pb-3 border-b border-primary/10">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-xs text-muted-foreground italic">mood:</span>
                  <span className="text-xs text-secondary text-glow-copper">{thinking.mood}</span>
                </div>
              </div>
        ...
        {filteredThinkings.length === 0 && (
          <div className="border border-primary/20 bg-card/10 p-12 text-center">
            <div className="font-mono text-sm text-muted-foreground">[No thinkings found with tag: #{selectedTag}]</div>
            <button
              onClick={() => setSelectedTag(null)}
        ...
        <div className="mt-16 border border-primary/20 bg-card/10 p-6 font-mono text-xs text-muted-foreground">
          <p>
            <span className="text-primary">Note:</span> These are raw, unedited thoughts. Typos, half-formed ideas, and
